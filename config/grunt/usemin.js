  ...
  options: {
    ...
    patterns: {
      ...
      'mp3': [
        ...
        [
          /['"](\/med\/[^'"\)]+)['"]/gm, //"/med/ring.mp3"
          'Update the JS to reference our revved mp3 files',
          filterIn,
          filterOut
        ]
      ],
      'image': [
        /*jshint regexp:false */
        [
          /['"](\/images\/[^'"\)]+\.(png|jpg|gif))['"]/gi, //"/images/user.png"
          'Update the JS to reference our revved iamges files',
          filterIn,
          filterOut
        ]
      ]
